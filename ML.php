...
<body>
  ...
  <main id="main">
    ...
    <!-- ======= Blog Section ======= -->
    <section class="breadcrumbs MLtopic">
      <div class="container">
    ...
    <section class="blog" data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-duration="500">
        ...
        <div class="row">
            ...
            <?php 
            // Task 1 get posts to $posts variable
            $posts = ml_posts();
            
            // Task 2 write loop for $posts as $post
            ...
            <div class="post-preview">
                ...
                <h2>
                    <?php 
                    // Task 3 print title 
                    echo "<a class='nav-link' href='".$post['src']."'>";
                    echo $post['title'];
                    echo "</a>";
                    ?>
                </h2>
                ...
                <div class="intro">
                <div class="clearfix">
                    <img src="<?php echo $post['image']; ?>" style ="width:20em" class="float-left img-thumbnail mr-3" />
                    <p>
                    <?php 
                    // Task 4 print intro 
                    echo $post['intro'];
